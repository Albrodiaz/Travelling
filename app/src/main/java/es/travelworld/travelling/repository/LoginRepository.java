...
public class LoginRepository {
    ...
    public void getResultLogin(String name, String password, CallbackLogin callbackLogin) {
        ApiUtils.getApiLogin().doLogin(name, password).enqueue(new Callback<ResponseLogin>() {
            @Override
